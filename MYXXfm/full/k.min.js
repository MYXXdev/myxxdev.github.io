...
s) {
    ...
    function i(t) {
		...
		,
		m=function(t) {
			this.canvas=O.createElement("canvas"), this.context=this.canvas.getContext("2d"), O.body.appendChild(this.canvas), this.width=this.canvas.width=t.width, this.height=this.canvas.height=t.height, this.context.drawImage(t, 0, 0, this.width, this.height)
		}
		,
		t=function() {};
		if(m.prototype= {
		...
		f=function() {
			...
			function i(t) {
				...
				return {
					...
					,
					peek:function(t) {
						return n||e(), t===s&&(t=a.length-1), a[t]
					}
					,
					pop:function() {
						return n||e(), a.pop()
			...
			s) {
				var i=this;
				i.r1=t, i.r2=e, i.g1=a, i.g2=n, i.b1=r, i.b2=o, i.histo=s
			}
			function u() {
			...
			function p(t,
			e) {
				var a, n, r, o=1e6, s=0, i=1e6, l=0, u=1e6, c=0;
				return t.forEach(function(t) {
			...
			u) {
				function e(t) {
					...
					c++)if(p[c]>d/2) {
						...
						return n[i]=o, r[s]=n[i]+1, [n, r]
					}
				}
				if(u.count()) {
					var a=u.r2-u.r1+1, n=u.g2-u.g1+1, r=u.b2-u.b1+1, o=g.max([a, n, r]);
			...
			return d.prototype= {
				...
				count:function(t) {
					...
					if(!e._count_set||t) {
						...
						r++)for(o=e.b1;
						o<=e.b2;
						o++)index=f(n, r, o), s+=a[index]||0;
						e._count=s, e._count_set=!0
					}
					return e._count
				}
				,
				...
				avg:function(t) {
					var e=this, a=e.histo;
					if(!e._avg||t) {
						var n, r, o, s, i=0, l=1<<8-h, u=0, c=0, d=0;
						for(r=e.r1;
						r<=e.r2;
						r++)for(o=e.g1;
						o<=e.g2;
						o++)for(s=e.b1;
						s<=e.b2;
						s++)i+=n=a[f(r, o, s)]||0, u+=n*(r+.5)*l, c+=n*(o+.5)*l, d+=n*(s+.5)*l;
						e._avg=i?[~~(u/i), ~~(c/i), ~~(d/i)]: [~~(l*(e.r1+e.r2+1)/2), ~~(l*(e.g1+e.g2+1)/2), ~~(l*(e.b1+e.b2+1)/2)]
					}
					return e._avg
				}
				,
				contains:function(t) {
					var e=this, a=t[0]>>k;
					return gval=t[1]>>k, bval=t[2]>>k, a>=e.r1&&a<=e.r2&&gval>=e.g1&&gval<=e.g2&&bval>=e.b1&&bval<=e.b2
				}
			}
			,
			u.prototype= {
				...
				forcebw:function() {
					...
					var e=t[0].color;
					e[0]<5&&e[1]<5&&e[2]<5&&(t[0].color=[0,
					0,
					0]);
					var a=t.length-1,
					n=t[a].color;
					251<n[0]&&251<n[1]&&251<n[2]&&(t[a].color=[255,
					255,
					255])
				}
			}
		...
		h=function(t) {
			...
			a.prototype= {
				init: function() {
					...
					,
					r.container="body");
					var t=O.querySelector(r.container),
					e=r.colors,
					a="object"==typeof e?"kast-primary-"+e.primary.replace(" ",
					""):"",
					o="object"==typeof e?"kast-accent-"+e.accent.replace(" ",
					""):"",
					s="string"==typeof e?"kast-colors-"+e:"",
					i=n.mobile&&n.mobileUltra?"kast-ultra":"",
					l=r.statusBar&&r.muteUnmute&&r.minimizeMaximize?"":"kast-not-full-statusbar",
					u=r.played?" kast-played ":" kast-current ",
					c="body"!==r.container?"kast-custom-container":"",
					d=t.offsetWidth<100%?"kast-thin-container":"",
					p="dynamic"===r.theme?"kast-light":"",
					m="",
					f="";
					if(r.statusBar) {
					...
					var v=r.continuous?"kast-paused kast-continuous ":"kast-stopped ",
					y="";
					y+='<div id="kast" class="kast-recss kast-'+r.theme+" kast-"+r.ui+" "+a+" "+o+" "+s+" kast-"+r.startTemplate+" kast-"+r.position+" "+i+" "+l+u+" "+c+" "+p+" "+d+'">',
					y+='<div id="kast-wrapper">',
					y+=m,
					y+='<div id="kast-top" class="kast-default-art">',
					y+='<div class="kast-album-wrapper"><i class="kast-mdi kast-mdi-album"></i></div>',
					y+='<div id="kast-top-content" class="kast-top-content">',
					y+='<div id="kast-nowplaying"><p id="kast-np-title">&nbsp;</p><p id="kast-np-artist">&nbsp;</p><p class="kast-home-link-title"><a target="_blank" href="https://www.cloudrad.io/radio-player">by Cloudrad.io</a></p></div>',
					y+='<div id="kast-linear"></div>',
					y+="</div>",
					y+='<div id="kast-play" class="'+v+'">',
					y+='<i class="kast-mdi kast-mdi-play"></i>',
					y+='<i class="kast-mdi kast-mdi-pause"></i>',
					y+='<i class="kast-mdi kast-mdi-stop"></i>',
					y+="</div></div>"+f+"</div></div>",
					t.insertAdjacentHTML("beforeend",
					y),
					r.onReady(),
					(r.statusBar||r.currentTrack||r.currentArtist)&&this.stats(function(t) {
						var e=r.serverInfo;
						if(e&&r.statusBar) {
					...
					r.played&&(Array.isArray&&Array.isArray(r.artwork)?n.played(!1,
					!0):n.played());
					var g=r.autoUpdate;
					return"all"===g?n.autoUpdate("all"):g&&n.autoUpdate(!0),
					O.getElementById("kast-play").onclick=function() {
				...
				play:function(t) {
					...
					(t||r)&&(this.audio.load(),
					r&&e.removeAttribute("data-offline"));
					var o=this.audio.play(),
					s=this;
					return null!==o&&o["catch"](function() {
						s&&s.stop()
					}
					),
					this.opt.onPlay(this.audio),
					this
				}
				,
				pause:function() {
